  ...
  group('BottomNavBar', () {
    ...
    testWidgets('renders without error', (tester) async {
      await tester.pumpWidget(
        testApp(BottomNavBar(selectedIndex: 0, onTap: (_) {})),
      );
    ...
    testWidgets('selecting index 2 highlights Measure tab', (tester) async {
      await tester.pumpWidget(
        testApp(BottomNavBar(selectedIndex: 2, onTap: (_) {})),
      );
    ...
    testWidgets('tapping a tab calls onTap with correct index', (tester) async {
      int? tappedIndex;
      await tester.pumpWidget(
        testApp(BottomNavBar(selectedIndex: 0, onTap: (i) => tappedIndex = i)),
      );
    ...
    testWidgets('tapping Measure tab calls onTap with index 2', (tester) async {
      int? tappedIndex;
      await tester.pumpWidget(
        testApp(BottomNavBar(selectedIndex: 0, onTap: (i) => tappedIndex = i)),
      );
    ...
    testWidgets(
      'tints the active tab icon with onSurface, inactive with textTertiary',
      (tester) async {
        await tester.pumpWidget(
          testApp(BottomNavBar(selectedIndex: 0, onTap: (_) {})),
        );
        ...
        final trendsIcon = tester.widget<SvgPicture>(
          find.descendant(
            of: find.ancestor(
              of: find.text('Trends'),
              matching: find.byType(GestureDetector),
