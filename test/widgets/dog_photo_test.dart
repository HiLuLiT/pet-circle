...
void main() {
  group('DogPhoto', () {
    ...
    testWidgets('renders without error', (tester) async {
      await tester.pumpWidget(testApp(const DogPhoto(endpoint: '')));
    ...
    testWidgets('non-empty http endpoint does not show placeholder', (
      ...
      await tester.pumpWidget(
        testApp(const DogPhoto(endpoint: 'https://example.com/dog.jpg')),
      );
      await tester.pump();
    ...
    testWidgets('non-http non-empty endpoint does not show placeholder', (
      ...
      await tester.pumpWidget(
        testApp(const DogPhoto(endpoint: 'some_local_path')),
      );
      await tester.pump();
