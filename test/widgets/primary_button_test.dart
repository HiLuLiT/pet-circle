  ...
  group('PrimaryButton', () {
    ...
    testWidgets('renders without error', (tester) async {
      await tester.pumpWidget(
        testApp(PrimaryButton(label: 'OK', onPressed: () {})),
      );
    ...
    testWidgets('disabled button (onPressed: null) does not respond to tap', (
      ...
      var tapped = false;
      await tester.pumpWidget(
        testApp(const PrimaryButton(label: 'Disabled', onPressed: null)),
      );
    ...
    testWidgets('renders icon when provided', (tester) async {
      await tester.pumpWidget(
        testApp(PrimaryButton(label: 'Add', icon: Icons.add, onPressed: () {})),
      );
    ...
    testWidgets('full width via SizedBox width: infinity', (tester) async {
      await tester.pumpWidget(
        testApp(PrimaryButton(label: 'Wide', onPressed: () {})),
      );
    ...
    testWidgets('calls onPressed when tapped', (tester) async {
      var callCount = 0;
      await tester.pumpWidget(
        testApp(PrimaryButton(label: 'Tap Me', onPressed: () => callCount++)),
      );
    ...
    testWidgets('label uses 16px / 700 weight for filled variant', (
      ...
      await tester.pumpWidget(
        testApp(PrimaryButton(label: 'Token', onPressed: () {})),
      );
    ...
    testWidgets(
      'label uses 16px / 700 weight for outlined (tertiary) variant',
      (tester) async {
        await tester.pumpWidget(
          testApp(
            PrimaryButton(
    ...
    testWidgets('uses DS button padding (32x16) and height 54', (tester) async {
      await tester.pumpWidget(
        testApp(PrimaryButton(label: 'Padded', onPressed: () {})),
      );
    ...
    testWidgets('foregroundColor overrides default text color', (tester) async {
      await tester.pumpWidget(
        testApp(
          PrimaryButton(
            label: 'Custom',
    ...
    testWidgets('child overrides label content', (tester) async {
      await tester.pumpWidget(
        testApp(
          PrimaryButton(child: const Text('Custom Child'), onPressed: () {}),
        ),
      );
    ...
    group('link variant', () {
      testWidgets(
        'renders label text with no background and no 56h fixedSize',
        (tester) async {
          await tester.pumpWidget(
            testApp(
              PrimaryButton(
