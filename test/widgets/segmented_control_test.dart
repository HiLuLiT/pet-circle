  ...
  group('AppSegmentedControl', () {
    ...
    testWidgets('renders every option label', (tester) async {
      await tester.pumpWidget(
        testApp(const AppSegmentedControl(options: options, value: 'Day')),
      );
    ...
    testWidgets('active segment uses surface background and bold text style', (
      tester,
    ) async {
      await tester.pumpWidget(
        testApp(const AppSegmentedControl(options: options, value: 'Week')),
      );
      ...
      final activeContainer = tester.widget<Container>(
        find
            .ancestor(of: find.text('Week'), matching: find.byType(Container))
            .first,
      );
    ...
    testWidgets('inactive segment is transparent with tertiary text', (
      tester,
    ) async {
      await tester.pumpWidget(
        testApp(const AppSegmentedControl(options: options, value: 'Week')),
