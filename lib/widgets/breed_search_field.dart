...
const allBreeds = [
  ...
  BreedItem(
    displayName: 'American Terrier',
    breed: 'terrier',
    subBreed: 'american',
  ),
  BreedItem(displayName: 'Appenzeller', breed: 'appenzeller'),
  BreedItem(
    displayName: 'Australian Cattledog',
    breed: 'cattledog',
    subBreed: 'australian',
  ),
  BreedItem(
  ...
  BreedItem(
    displayName: 'Cardigan Corgi',
    breed: 'corgi',
    subBreed: 'cardigan',
  ),
  BreedItem(
    displayName: 'Caucasian Ovcharka',
    breed: 'ovcharka',
    subBreed: 'caucasian',
  ),
  BreedItem(
  ...
  BreedItem(
    displayName: 'Chesapeake Retriever',
    breed: 'retriever',
    subBreed: 'chesapeake',
  ),
  ...
  BreedItem(
    displayName: 'English Sheepdog',
    breed: 'sheepdog',
    subBreed: 'english',
  ),
  BreedItem(
    displayName: 'English Springer',
    breed: 'springer',
    subBreed: 'english',
  ),
  ...
  BreedItem(
    displayName: 'Flatcoated Retriever',
    breed: 'retriever',
    subBreed: 'flatcoated',
  ),
  ...
  BreedItem(
    displayName: 'West Highland Terrier',
    breed: 'terrier',
    subBreed: 'westhighland',
  ),
  BreedItem(
    displayName: 'Wheaten Terrier',
    breed: 'terrier',
    subBreed: 'wheaten',
  ),
